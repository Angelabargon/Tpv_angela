...
/**
 * Controlador contenedor del área principal del administrador.
 */
public class ControladorGeneralAdmin
{
    ...
    {
        // Cargamos el contenido en el centro
        cambiarContenidoCentral(fxmlInterno);
        // Marcamos el botón comparando la ruta del FXML recibido
    ...
    @FXML private void clickCredenciales()
    ...
    /**
     * Método auxiliar usado por esta clase.
     * @param fxml archivo FXML que se carga.
     */
